--------------------------------------------------------
-- Archivo creado  - lunes-diciembre-12-2016   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Type CARRERA
--------------------------------------------------------

  CREATE OR REPLACE TYPE "SYSTEM"."CARRERA" AS OBJECT (
  NOMBRE VARCHAR2(25),
  ORGANIZADOR USUARIO_ORGANIZADOR,
  DISTANCIA NUMBER(3),
  DESNIVEL NUMBER(5),
  PRECIO NUMBER(4),
  FECHA DATE,
...
/
--------------------------------------------------------
--  DDL for Type USUARIO_ADMIN
--------------------------------------------------------

  CREATE OR REPLACE TYPE "SYSTEM"."USUARIO_ADMIN" AS OBJECT (
  NOMBRE VARCHAR2(25),
...
/
--------------------------------------------------------
--  DDL for Type USUARIO_NORMAL
--------------------------------------------------------

  CREATE OR REPLACE TYPE "SYSTEM"."USUARIO_NORMAL" AS OBJECT (
  NOMBRE VARCHAR2(25),
  APELLIDOS VARCHAR2(25),
  EMAIL VARCHAR2(25),
  PASSWORD VARCHAR2(10),
...
/
--------------------------------------------------------
--  DDL for Type USUARIO_ORGANIZADOR
--------------------------------------------------------

  CREATE OR REPLACE TYPE "SYSTEM"."USUARIO_ORGANIZADOR" AS OBJECT (
  ID NUMBER(2),
  NOMBRE VARCHAR2(25),
  APELLIDOS VARCHAR2(25),
  EMAIL VARCHAR2(25),
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CARRERAS" OF "SYSTEM"."CARRERA" 
 ...
 PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table USUARIOS_ADMIN
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."USUARIOS_ADMIN" OF "SYSTEM"."USUARIO_ADMIN" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ) 
 PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table USUARIOS_NORMAL
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."USUARIOS_NORMAL" OF "SYSTEM"."USUARIO_NORMAL" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ) 
 PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table USUARIOS_ORGANIZADOR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."USUARIOS_ORGANIZADOR" OF "SYSTEM"."USUARIO_ORGANIZADOR" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ) 
 PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Sequence ID_ORG
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."ID_ORG"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 4 NOCACHE  NOORDER  NOCYCLE ;
REM INSERTING into SYSTEM.CARRERAS
SET DEFINE OFF;
Insert into SYSTEM.CARRERAS (NOMBRE,ORGANIZADOR,DISTANCIA,DESNIVEL,PRECIO,FECHA,LUGAR) values ('APUKO IGOERA',SYSTEM.USUARIO_ORGANIZADOR(1,'Unai Org','Sainz','unai@org.com','org1234','gorosibai n17',946002941,'TTB'),'31','2600','40',to_date('09/09/99','DD/MM/RR'),'Usansolo');
Insert into SYSTEM.CARRERAS (NOMBRE,ORGANIZADOR,DISTANCIA,DESNIVEL,PRECIO,FECHA,LUGAR) values ('BKT Trapaga',SYSTEM.USUARIO_ORGANIZADOR(3,'unaitxo','Irati','irati@org.com','Irati1234','Irati direc',946002921,'TTB'),'20','500','21',to_date('02/05/17','DD/MM/RR'),'Bilbao');
Insert into SYSTEM.CARRERAS (NOMBRE,ORGANIZADOR,DISTANCIA,DESNIVEL,PRECIO,FECHA,LUGAR) values ('Enkarterri Trail',SYSTEM.USUARIO_ORGANIZADOR(1,'Unai Org','Sainz','unai@org.com','org1234','gorosibai n17',946002941,'TTB'),'30','3000','40',to_date('01/01/13','DD/MM/RR'),'Karrantza');
Insert into SYSTEM.CARRERAS (NOMBRE,ORGANIZADOR,DISTANCIA,DESNIVEL,PRECIO,FECHA,LUGAR) values ('Maraton de las Tucas',SYSTEM.USUARIO_ORGANIZADOR(1,'Unai Org','Sainz','unai@org.com','org1234','gorosibai n17',946002941,'TTB'),'41','3500','50',to_date('01/05/13','DD/MM/RR'),'Benasque');
Insert into SYSTEM.CARRERAS (NOMBRE,ORGANIZADOR,DISTANCIA,DESNIVEL,PRECIO,FECHA,LUGAR) values ('BKT Lekeitio',SYSTEM.USUARIO_ORGANIZADOR(2,'Oscar Org','Perea','oscar@org.com','Org1234','gorosibai n11',946002941,'BKT'),'20','500','21',to_date('01/05/17','DD/MM/RR'),'Bilbao');
Insert into SYSTEM.CARRERAS (NOMBRE,ORGANIZADOR,DISTANCIA,DESNIVEL,PRECIO,FECHA,LUGAR) values ('Karraderan',SYSTEM.USUARIO_ORGANIZADOR(4,'Iker','Sainz','iker@org.com','Iker1234','Bilbao n12',946002931,'BKT'),'30','3000','11',to_date('02/09/17','DD/MM/RR'),'Larrabetzu');
REM INSERTING into SYSTEM.USUARIOS_ADMIN
SET DEFINE OFF;
Insert into SYSTEM.USUARIOS_ADMIN (NOMBRE,APELLIDOS,EMAIL,PASSWORD,DIRECCION,TELEFONO,CLUB) values ('admin','admin','admin@admin.com','Admin1234','gorosibai n18','946002941','club-admin');
REM INSERTING into SYSTEM.USUARIOS_NORMAL
SET DEFINE OFF;
Insert into SYSTEM.USUARIOS_NORMAL (NOMBRE,APELLIDOS,EMAIL,PASSWORD,DIRECCION,TELEFONO,CLUB) values ('unai','sainz','unai@unai.com','Unai1234','Gorosibai n18','946002941','TTB');
Insert into SYSTEM.USUARIOS_NORMAL (NOMBRE,APELLIDOS,EMAIL,PASSWORD,DIRECCION,TELEFONO,CLUB) values ('normal','normal','normal@normal.com','Normal1234','Goro','946002941','TTB');
REM INSERTING into SYSTEM.USUARIOS_ORGANIZADOR
SET DEFINE OFF;
Insert into SYSTEM.USUARIOS_ORGANIZADOR (ID,NOMBRE,APELLIDOS,EMAIL,PASSWORD,DIRECCION,TELEFONO,CLUB) values ('1','Unai Org','Sainz','unai@org.com','Org1234','gorosibai n17','946002941','TTB');
Insert into SYSTEM.USUARIOS_ORGANIZADOR (ID,NOMBRE,APELLIDOS,EMAIL,PASSWORD,DIRECCION,TELEFONO,CLUB) values ('4','Iker','Sainz','iker@org.com','Iker1234','Bilbao n12','946002931','BKT');
Insert into SYSTEM.USUARIOS_ORGANIZADOR (ID,NOMBRE,APELLIDOS,EMAIL,PASSWORD,DIRECCION,TELEFONO,CLUB) values ('3','unaitxo','irati','irati@org.com','Irati1234','Irati direc','946002921','TTB');
--------------------------------------------------------
--  DDL for Index SYS_C007086
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007086" ON "SYSTEM"."CARRERAS" ("NOMBRE") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007087" ON "SYSTEM"."CARRERAS" ("SYS_NC_OID$") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007088" ON "SYSTEM"."USUARIOS_ADMIN" ("EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007089" ON "SYSTEM"."USUARIOS_ADMIN" ("SYS_NC_OID$") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007090" ON "SYSTEM"."USUARIOS_NORMAL" ("EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007091" ON "SYSTEM"."USUARIOS_NORMAL" ("SYS_NC_OID$") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007092" ON "SYSTEM"."USUARIOS_ORGANIZADOR" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007093" ON "SYSTEM"."USUARIOS_ORGANIZADOR" ("SYS_NC_OID$") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Procedure INSERTAR_AGENDA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."INSERTAR_AGENDA" (N VARCHAR2, T TELEFONO) AS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Function DEVOLVER_PRIMERO
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."DEVOLVER_PRIMERO" (A VARCHAR2) RETURN VARCHAR2 IS
  CURSOR C IS SELECT * FROM AGENDA WHERE NOMBRE = A;
BEGIN
  
  FOR J IN C LOOP
    IF J.TELEF.COUNT > 0 THEN
      RETURN J.TELEF(1);
    ELSE
      RETURN 'NO TIENE TELEFONO ASOCIADO.';
    END IF;
  END LOOP;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CARRERAS" ADD UNIQUE ("SYS_NC_OID$")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CARRERAS" ADD PRIMARY KEY ("NOMBRE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USUARIOS_ADMIN" ADD UNIQUE ("SYS_NC_OID$")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."USUARIOS_ADMIN" ADD PRIMARY KEY ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table USUARIOS_NORMAL
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."USUARIOS_NORMAL" ADD UNIQUE ("SYS_NC_OID$")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."USUARIOS_NORMAL" ADD PRIMARY KEY ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table USUARIOS_ORGANIZADOR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."USUARIOS_ORGANIZADOR" ADD UNIQUE ("SYS_NC_OID$")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."USUARIOS_ORGANIZADOR" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
