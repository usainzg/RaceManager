		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(validarEntrada() == true){
					...
					if(comboBox.getSelectedItem().equals("Normal")){
						UsuarioEstandar uViejo = new UsuarioEstandar("", "", comboBox_1.getSelectedItem().toString(), "", "", 0,""); 
						...
						UsuarioOrganizador uViejo = new UsuarioOrganizador("", "", "", comboBox_1.getSelectedItem().toString(), "", 0,""); 
