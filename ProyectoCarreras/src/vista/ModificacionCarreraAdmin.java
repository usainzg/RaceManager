...
public class ModificacionCarreraAdmin extends JFrame {
	...
	public ModificacionCarreraAdmin() {
		...
		txtEj.setText("Ej. 1999-09-09");
		txtEj.setBounds(149, 256, 130, 26);
		getContentPane().add(txtEj);
		txtEj.setColumns(10);

		txtEj.addFocusListener(new FocusListener() {
