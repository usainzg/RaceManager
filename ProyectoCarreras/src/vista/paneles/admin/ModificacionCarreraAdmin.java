...
public class ModificacionCarreraAdmin extends JPanel {
	...
	private void setLayout(){
		...
		gridBagLayout.columnWidths = new int[]{59, 135, 146, 54, 0};
		gridBagLayout.rowHeights = new int[]{20, 20, 23, 0, 0, 0, 0, 35, 0, 0};
		...
		setLayout(gridBagLayout);
										...
										gbc_lblCarreraAModificar.gridy = 0;
